...
parser.add_argument('split_folder', type=str, help="The folder name to process (containing train_images, val_images, train_masks, val_masks)")
parser.add_argument('ids', nargs='+', help="The ids (names) of the annotations")
args = parser.parse_args()
proj_dir = args.proj_dir
split_folder = args.split_folder
ids = args.ids

print(f"Creating ids {ids}")

print("Converting binary masks to COCO JSON format...")

# Label IDs of the dataset representing different categories
category_ids = {id: i + 1 for i, id in enumerate(ids)}
print(category_ids)
...
if __name__ == "__main__":
    # Ajay paths
    # train_mask_path = "D:/McGill projects/DDC-DU/train_masks"
    # train_json_path = "D:/McGill projects/DDC-DU/json/train.json"

    # Matthew Paths
    train_mask_path = f"{proj_dir}/yolo/{split_folder}/train_masks" #"C:/Users/matth/Documents/MUHC/yolo/train_masks"
    train_json_path = f"{proj_dir}/json/{split_folder}/train.json" #"C:/Users/matth/Documents/MUHC/json/train.json"
    process_masks(train_mask_path, train_json_path)

    # Ajay paths
    # val_mask_path = "D:/McGill projects/DDC-DU/val_masks"
    # val_json_path = "D:/McGill projects/DDC-DU/json/val.json"

    # Matthew Paths
    val_mask_path = f"{proj_dir}/yolo/{split_folder}/val_masks" #"C:/Users/matth/Documents/MUHC/yolo/val_masks"
    val_json_path = f"{proj_dir}/json/{split_folder}/val.json" #"C:/Users/matth/Documents/MUHC/json/val.json"
