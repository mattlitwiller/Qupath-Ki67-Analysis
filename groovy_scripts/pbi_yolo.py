...
try:
    ...
    print("Module 'patched_yolo_infer' not found. Installing it...")
    subprocess.check_call([sys.executable, "-m", "pip", "install", "patched_yolo_infer"])
...
if batch_folder is not None: 
    image_path = f"{batch_folder}/{image_file}"
...
export_dir = f"D:/Qupath/ProjectTestbench/predictions"
if (not os.path.exists(export_dir)):
    os.mkdir(export_dir)
yolo_model_path = f"D:/Qupath/models/{classes}/trained_yolo11n_{classes}.pt"
